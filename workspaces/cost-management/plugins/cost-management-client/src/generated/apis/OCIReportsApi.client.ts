 ...
 * no description
 */
export class OCIReportsApiClient {
     ...
     */
    public async getOciCostReports(
        // @ts-ignore
        request: {
            query: {
                delta?: string,
        ...
        const uriTemplate = `/reports/oci/costs/{?delta,filter,group_by,order_by,offset,limit,start_date,end_date}`;
     ...
     * @param endDate String to indicate end date of date range.
     */
    public async getOciInstanceReports(
        // @ts-ignore
        request: {
            query: {
                filter?: any,
        ...
        const uriTemplate = `/reports/oci/instance-types/{?filter,group_by,order_by,offset,limit,start_date,end_date}`;
     ...
     * @param endDate String to indicate end date of date range.
     */
    public async getOciStorageReports(
        // @ts-ignore
        request: {
            query: {
                filter?: any,
        ...
        const uriTemplate = `/reports/oci/storage/{?filter,group_by,order_by,offset,limit,start_date,end_date}`;
