...
export class AzureReportsApiClient {
     ...
     */
    public async getAzureCostReports(
        // @ts-ignore
        request: {
            query: {
                delta?: string,
        ...
        const uriTemplate = `/reports/azure/costs/{?delta,filter,group_by,order_by,offset,limit,start_date,end_date}`;
     ...
     * @param endDate String to indicate end date of date range.
     */
    public async getAzureInstanceReports(
        // @ts-ignore
        request: {
            query: {
                filter?: any,
        ...
        const uriTemplate = `/reports/azure/instance-types/{?filter,group_by,order_by,offset,limit,start_date,end_date}`;
     ...
     * @param endDate String to indicate end date of date range.
     */
    public async getAzureStorageReports(
        // @ts-ignore
        request: {
            query: {
                filter?: any,
        ...
        const uriTemplate = `/reports/azure/storage/{?filter,group_by,order_by,offset,limit,start_date,end_date}`;
